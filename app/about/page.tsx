...
export default async function Page() {
  ...
  return (
    <div className="grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center overflow-hidden">
      ...
      <div className="min-[1px]:hidden min-[1150px]:block col-span-2">
        <Image
          src={image2}
          placeholder="blur"
          quality={80}
      ...
      <div className="min-[1px]:col-span-full min-[1150px]:col-span-3">
        ...
        <div className="space-y-8 max-[380px]:w-[85%]">
          ...
          <div className="max-[1150px]:w-full w-fit">
            <a
              href="/cabins"
              className="inline-block mt-4 bg-accent-500 px-8 py-5 text-primary-800 text-lg font-semibold hover:bg-accent-600 transition-all w-full text-center"
            >
              Explore our luxury cabins
            </a>
          </div>
          <div className="min-[1px]:block min-[1150px]:hidden col-span-full">
            <Image
              src={image2}
              placeholder="blur"
              quality={80}
